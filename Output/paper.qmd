...
date: "today"
date-format: "long" 
abstract: "This study presents an analysis of crime rates in the Wexford/Maryvale and Kensington-Chinatown neighborhoods over a ten-year period, revealing a notable increase in crime rates, especially in Kensington-Chinatown. The findings suggest that local socio-economic factors may significantly influence crime trends."
format: pdf
...
To examine the trends of crime in Toronto, I have sourced the "Neighbourhood Crime Rates" dataset from the Toronto Open Data Portal [@citeOpendataToronto]. This dataset, published by the City of Toronto [@citeCrimeRates], details crime statistics across various neighborhoods from 2014 to 2023. It has different crime types, including but not limited to assault, shooting, and theft, and presents these data points in the context of annual crime rates per 100,000 population.
...
kable_table <- kable(wexford_table, "latex", booktabs = TRUE, digits = 1, longtable = TRUE) |>
...
# Proceed with creating the table using kable
kensington_kable_table <- kable(kensington_table, "latex", booktabs = TRUE, digits = 1, longtable = TRUE) |>
  kable_styling(latex_options = c("repeat_header"))
