...
To examine the trends of crime in Toronto, I have sourced the "Neighbourhood Crime Rates" dataset from the Toronto Open Data Portal [@citeOpendataToronto]. This dataset, published by the City of Toronto, details crime statistics across various neighborhoods from 2014 to 2023. It has different crime types, including but not limited to assault, shooting, and theft, and presents these data points in the context of annual crime rates per 100,000 population.
